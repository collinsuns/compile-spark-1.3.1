...
private[spark] class Worker(
  ...
  override def receiveWithLogging = {
    ...
    // TODO: master 发送给Worker的消息，让Worker启动Executor，LaunchExecutor是一个Case Class，里面封装了以后要启动的Executor的信息
    case LaunchExecutor(masterUrl, appId, execId, appDesc, cores_, memory_) =>
      if (masterUrl != activeMasterUrl) {
        ...
        try {
          ...
          // TODO: 创建一个ExecutorRunner，将参数都放到其中，然后在通过它启动Executor
          ...
          // TODO: 把ExecutorId -> Executor放到一个Map中 
